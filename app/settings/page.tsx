...
import { 
  Sun, Moon, Globe, Lock, Shield, 
  Bell, Mail, Trash2, Camera, User, 
  Check, AlertTriangle
} from "lucide-react";
    ...
    <div className="settings-page-shell app-shell">
      ...
      <main className="settings-content app-content">
        <div className="page-header-block">
          ...
          <p className="page-subtitle">Configure your personal workspace and security preferences</p>
        </div>
        ...
        <div className="settings-layout-grid">
          ...
          <div className="settings-col">
              ...
              <div className="settings-form">
                <div className="form-row">
                  <label className="field-group">
                    ...
                    <input defaultValue="Lyna Larinouna" placeholder="Enter your full name" />
                  </label>
                  <label className="field-group">
                    <span>Gender</span>
                ...
                <label className="field-group">
                  ...
                  <textarea rows={3} defaultValue="AI Engineer specializing in intelligent construction systems and 5D estimation pipelines." />
                </label>
            ...
            <section className="settings-card">
              <div className="card-header">
                <div className="header-icon secondary"><Lock size={20} /></div>
                <div>
              ...
              <form className="settings-form" onSubmit={handleChangePassword}>
                ...
                <div className="security-check-list">
                  <div className="check-item enabled">
                    <Shield size={16} />
                    <span>Two-Factor Authentication (2FA) is currently <strong>enabled</strong></span>
          ...
          <div className="settings-col">
            ...
            <section className="settings-card">
              <div className="card-header">
                <div className="header-icon"><Sun size={20} /></div>
                <div>
                  <h3>Appearance</h3>
              ...
              <div className="theme-grid">
                ...
                >
                  <div className="tile-icon light"><Sun size={20} /></div>
                  <div className="tile-content">
                    <strong>Day Mode</strong>
                    <p>High contrast for bright environments</p>
                  </div>
                  {theme === 'light' && <Check size={16} className="check-mark" />}
                </button>
                <button 
                  className={`theme-tile ${theme === 'dark' ? 'selected' : ''}`}
                  onClick={() => setTheme('dark')}
                >
                  <div className="tile-icon dark"><Moon size={20} /></div>
                  <div className="tile-content">
                    <strong>Night Mode</strong>
                    <p>Gentle on eyes in low light</p>
                  </div>
                  {theme === 'dark' && <Check size={16} className="check-mark" />}
                </button>
              </div>
            </section>
            ...
            <section className="settings-card">
              <div className="card-header">
                <div className="header-icon"><Globe size={20} /></div>
                <div>
            ...
            <section className="settings-card">
              ...
              <div className="notify-list">
                ...
                <div className="notify-item">
                  ...
                  <label className="switch">
                    <input type="checkbox" checked={browserNotify} onChange={() => setBrowserNotify(!browserNotify)} />
                    <span className="slider"></span>
                  </label>
                </div>
              </div>
            ...
            <section className="settings-card danger">
              <div className="card-header">
                <div className="header-icon danger"><AlertTriangle size={20} /></div>
                <div>
                  <h3>Danger Zone</h3>
              ...
              <div className="danger-actions">
                ...
                <p className="danger-hint">Once you delete your account, there is no going back. Please be certain.</p>
              </div>
            </section>
          </div>
        </div>
