...
export function MonthView({
  ...
  return (
    <div data-slot="month-view" className="contents">
      ...
      <div className="grid flex-1 auto-rows-fr min-h-0 overflow-hidden">
        {weeks.map((week, weekIndex) => (
          <div
            key={`week-${weekIndex}`}
            className="grid grid-cols-7 [&:last-child>*]:border-b-0 min-h-0 overflow-hidden"
          >
            {week.map((day, dayIndex) => {
              ...
              return (
                <div
                  key={day.toString()}
                  className="group border-border/70 data-outside-cell:bg-muted/25 data-outside-cell:text-muted-foreground/70 border-r border-b last:border-r-0 overflow-hidden min-h-0"
